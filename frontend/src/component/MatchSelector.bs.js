      ...
      if (match$2 !== undefined) {
        ...
        if (match$3 !== undefined) {
          ...
          if (match$4 !== undefined) {
            ...
            tmp$2 = Js_exn.raiseError("graphql_ppx: Field id on type Match is missing");
          }
          tmp$1 = {
            id: tmp$2
          };
  ...
  return /* record */[
          ...
          /* render */(function (param) {
              ...
              if (typeof state === "number") {
                ...
                var matchList = List.length(matches) === 0 ? React.createElement("span", undefined, "No matches") : React.createElement("ul", undefined, $$Array.of_list(List.map((function (match_) {
